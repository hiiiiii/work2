...
<body onload="assign()"  style="background-color: #FFCC00 ">
    ...
    <%String jsp="Chicken Kadhai Items";%>
...
<%
        ...
        String select = "select * from product where Cid=1 and Sid=1";
        ...
        if (add != "" && add != null) {
            ...
            if(user=="" || user==null){
                RequestDispatcher rd=request.getRequestDispatcher("LoginFirst.jsp");
